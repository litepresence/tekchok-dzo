...
The Literal Layer provides:

1. **Grammatical Transparency:** Every particle and suffix visible
2. **Syntactic Mapping:** Tibetan word order preserved
...
Every Tibetan particle is represented:
- *kyis* → "by means of" / "through"
- *las* → "from" / "out of"
- *la* → "to" / "in" / "at"

**Compounds**

Hyphenated to reflect nonduality:
- *snang stong* → "appearance-emptiness"
- *rig pa* → "awareness" (not "rigpa" as proper noun)

**Articles**

Omitted unless Tibetan explicitly marks definiteness:
- No: "the ground," "a practitioner"
- Yes: "ground," "practitioner"
...
Tibetan:
```
gdod nas rnam dag spros kun zhi ba
```

Literal:
```
from-primordial pure elaboration all pacified
```

Liturgical (for comparison):
```
...
The Literal Layer provides the grammatical skeleton. Use it to:
- Verify syntax of interpretive translations
- Identify grammatical ambiguities
- Map relationships between terms
- Build your own translations

**For Students**

Study the Literal Layer to understand:
- How Tibetan grammar works
- How particles function
- Why word order matters
- How meaning is grammatically constructed

**For Scholars**

The Literal Layer enables:
- Precise grammatical analysis
- Comparative translation study
- Verification of interpretive choices
