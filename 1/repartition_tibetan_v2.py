        ...
        if current_page == start_page:
            ...
            if end_page and current_page == end_page:
                ...
                if end_idx is None:
                    ...
                    # Start and end on same line - split it
                    ...
                    # Add partial last line up to end phrase
            ...
            if end_idx is None:
                ...
                # Add partial line up to end phrase
                line_num, prefix, content, full_line = lines[end_idx]
                stripped = content.lstrip()
                end_pos = stripped.find(end_phrase)
                segment = stripped[:end_pos]
...
def main():
    ...
    for i, section in enumerate(sections):
        ...
        # Extract content
        content_lines, markers_bytes = extract_section_content(section, next_section, volume_dir)
    ...
    # Show samples
    print(f"\nSample files:")
    for sample_name in ["01-01-01-01.txt", "01-02-01-03.txt", "01-02-01-04.txt", "01-02-01-05.txt"]:
