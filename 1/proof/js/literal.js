// Literal Layer - Navigation with ALN (Absolute Line Numbers)
// ALN: 1-37756
...
// Create layer-specific goToLine function
const goToLine = SharedJS.goToLineExact(state, totalChapters, SharedJS.showChapter(state, totalChapters));

// Setup the layer with shared utilities
SharedJS.setupTranslationLayer(state, totalChapters, goToLine);
