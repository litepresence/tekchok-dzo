...
<!-- Edit /js/tibetan.js and run process_tibetan.py to regenerate. -->
<script src="../js/shared.js"></script>
<script src="../js/tibetan.js"></script>
"""
...
<head>
    ...
    <!-- Edit the source files and run process_tibetan.py to regenerate. -->
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Tibetan Text Collection</title>
    <meta name="generator" content="Tibetan Parser">
    <meta name="created" content="{datetime.now().isoformat()}">
    <link rel="stylesheet" href="../css/tibetan.css">
    {js_script}
</head>
<body>
    <div class="document">
