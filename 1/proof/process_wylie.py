...
<style>
    ...
    * {
    ...
    /* Terminator markers (ending with */) */
    .terminator {
        color: var(--color-accent);
        font-weight: bold;
    }
...
def generate_file_html(parsed_lines, filename):
    ...
    for item in parsed_lines:
        ...
        html_parts.append(f'  <div class="line-content"><span class="wylie-line">{content}</span></div>')
...
def build_full_document(all_file_content, toc_entries):
    ...
    # Build TOC
    toc_html = '<div class="toc"><h1>Wylie Transliteration Index</h1><ul>'
