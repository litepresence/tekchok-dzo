...
def generate_file_html(parsed_lines, filename):
    ...
    for item in parsed_lines:
        ...
        html_parts.append(
            f'  <div class="line-content" id="line-{line_num}"><span class="wylie-line" data-line="{line_num}">{content}</span></div>'
        )
...
<!-- Edit /js/wylie.js and run process_wylie.py to regenerate. -->
...
<head>
    ...
    <!-- Edit the source files and run process_wylie.py to regenerate. -->
    <meta charset="UTF-8">
