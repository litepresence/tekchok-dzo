#!/usr/bin/env python3
"""
Normalize PAGE files in-place by stripping trailing whitespace.
...
def normalize_page_file(page_path):
    """
    Read file, strip trailing whitespace from each line, strip trailing empty lines.
    ...
    # Rejoin with \n and add final newline if there was content
    if normalized_lines:
